...
# How do i add users
**WFM** reads users accounts by going to **/config/WFMUSER.json** in a JSON Format:
{
 "(user)": {
   "caf":true,
   "crf":true,
...
**Go to (IP)/Admin** for administrator view. **Use credentials (default name: ADMIN, password: ADM90!X )**
